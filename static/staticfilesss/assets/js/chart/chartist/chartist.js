(function () {
  (function (root, factory) {
    ...
    /**
     * The step axis for step based charts like bar chart or step based line charts. It uses a fixed amount of ticks that will be equally distributed across the whole axis length. The projection is done using the index of the data value rather than the value itself and therefore it's only useful for seperation purpose.
     * **Options**
     * The following options are used by this axis in addition to the default axis options outlined in the axis configuration of the chart default settings.
     * ```javascript
     * var options = {
            ...
            data.normalized.series[seriesIndex].forEach(
              function (value, valueIndex) {
                ...
                if (labelAxis instanceof Chartist.StepAxis) {
                  ...
                  // Using bi-polar offset for multiple series if no stacked bars or series seperation is used
                  projected[labelAxis.units.pos] +=
