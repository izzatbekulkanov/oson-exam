...
function generateGuid() {
    ...
    return t
}), define("text!templates2/popover/popover-main.html", [], function() {
...
}), define("text!templates2/popover/popover-input.html", [], function() {
...
}), define("text!templates2/popover/popover-select.html", [], function() {
...
}), define("text!templates2/snippet/appendedtext.html", [], function() {
    return '<!-- Appended Input-->\n<div class="mb-3 row">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-lg-12" <%}else { %> "<%= inputsize %>"<%}%> >\n    <div class="input-group">\n      <input id="<%= id %>" name="<%= id %>" class="form-control btn-square" placeholder="<%= placeholder %>" type="text"<% if(required) {%> required <% } %> />\n      <span class="input-group-text btn btn-primary btn-right"><%= append %></span>\n    </div>\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n  </div>\n</div>'
}), define("text!templates2/snippet/filebutton.html", [], function() {
    return '<!-- File Button --> \n<div class="mb-3 row">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class="col-lg-12">\n    <input id="<%= id %>" name="<%= id %>" class="input-file" id="fileInput" type="file">\n  </div>\n</div>\n'
}), define("text!templates2/snippet/button.html", [], function() {
    return '<!-- Button -->\n<div class="mb-3 row">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class="col-lg-12">\n    <button id="<%= id %>" name="<%= id %>" class=\'btn <%= buttontype %>\'><%= buttonlabel %></button>\n  </div>\n</div>\n'
}), define("text!templates2/snippet/buttondouble.html", [], function() {
...
}), define("text!templates2/snippet/buttondropdown.html", [], function() {
...
}), define("text!templates2/snippet/multiplecheckboxes.html", [], function() {
...
}), define("text!templates2/snippet/multiplecheckboxesinline.html", [], function() {
...
}), define("text!templates2/snippet/multipleradios.html", [], function() {
...
}), define("text!templates2/snippet/multipleradiosinline.html", [], function() {
...
}), define("text!templates2/snippet/passwordinput.html", [], function() {
...
}), define("text!templates2/snippet/prependedcheckbox.html", [], function() {
    return '<!-- Prepended checkbox -->\n<div class="mb-3 row">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-lg-12" <%}else { %> "<%= inputsize %>"<%}%>>\n    <div class="input-group">\n      <span class="input-group-text">     \n          <input type="checkbox" <% if (checked){ %>checked="checked"<% } %>>     \n      </span>\n      <input id="<%= id %>" name="<%= id %>" class="form-control btn-square" type="text" placeholder="<%= placeholder %>" <% if(required) {%> required <% } %> />\n    </div>\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n  </div>\n</div>\n'
}), define("text!templates2/snippet/selectbasic.html", [], function() {
    return '<!-- Select Basic -->\n<div class="mb-3 row">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-lg-12" <%}else { %> "<%= inputsize %>"<%}%>>\n    <select id="<%= id %>" name="<%= id %>" class="form-control btn-square"><% _.each(options, function(option,i) { %>\n      <option value="<%= values[i] %>"><%= option %></option><% }); %>\n    </select>\n  </div>\n</div>\n'
}), define("text!templates2/snippet/selectmultiple.html", [], function() {
    return '<!-- Select Multiple -->\n<div class="mb-3 row mb-0">\n  <label class="col-lg-12 form-label text-lg-start" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-lg-12" <%}else { %> "<%= inputsize %>"<%}%>>\n    <select id="<%= id %>" name="<%= id %>" class="form-control btn-square" multiple="multiple"><% _.each(options, function(option,i) { %>\n      <option value="<%= values[i] %>"><%= option %></option><% }); %>\n    </select>\n  </div>\n</div>\n'
}), define("text!templates2/snippet/textarea.html", [], function() {
    return '<!-- Textarea -->\n<div class="mb-3 row mb-0">\n  <label class="col-lg-12 form-label text-lg-start" for ="<%= id %>"><%= label %></label>\n  <div class="col-lg-12" >                     \n    <textarea class="form-control btn-square" id="<%= id %>" name="<%= id %>" ><%= textarea %></textarea>\n  </div>\n</div>\n'
}), define("templates2/snippet/snippet-templates2", ["require", "text!templates2/snippet/formname.html", "text!templates2/snippet/prependedtext.html", "text!templates2/snippet/searchinput.html", "text!templates2/snippet/textinput.html", "text!templates2/snippet/appendedcheckbox.html", "text!templates2/snippet/appendedtext.html", "text!templates2/snippet/filebutton.html", "text!templates2/snippet/button.html", "text!templates2/snippet/buttondouble.html", "text!templates2/snippet/buttondropdown.html", "text!templates2/snippet/multiplecheckboxes.html", "text!templates2/snippet/multiplecheckboxesinline.html", "text!templates2/snippet/multipleradios.html", "text!templates2/snippet/multipleradiosinline.html", "text!templates2/snippet/passwordinput.html", "text!templates2/snippet/prependedcheckbox.html", "text!templates2/snippet/prependedtext.html", "text!templates2/snippet/searchinput.html", "text!templates2/snippet/selectbasic.html", "text!templates2/snippet/selectmultiple.html", "text!templates2/snippet/textarea.html", "text!templates2/snippet/textinput.html"], function(e) {
    var t = e("text!templates2/snippet/formname.html"),
        n = e("text!templates2/snippet/prependedtext.html"),
        r = e("text!templates2/snippet/searchinput.html"),
        i = e("text!templates2/snippet/textinput.html"),
        s = e("text!templates2/snippet/appendedcheckbox.html"),
        o = e("text!templates2/snippet/appendedtext.html"),
        u = e("text!templates2/snippet/filebutton.html"),
        a = e("text!templates2/snippet/button.html"),
        f = e("text!templates2/snippet/buttondouble.html"),
        l = e("text!templates2/snippet/buttondropdown.html"),
        c = e("text!templates2/snippet/multiplecheckboxes.html"),
        h = e("text!templates2/snippet/multiplecheckboxesinline.html"),
        p = e("text!templates2/snippet/multipleradios.html"),
        d = e("text!templates2/snippet/multipleradiosinline.html"),
        v = e("text!templates2/snippet/passwordinput.html"),
        m = e("text!templates2/snippet/prependedcheckbox.html"),
        n = e("text!templates2/snippet/prependedtext.html"),
        g = e("text!templates2/snippet/searchinput.html"),
        y = e("text!templates2/snippet/selectbasic.html"),
        b = e("text!templates2/snippet/selectmultiple.html"),
        w = e("text!templates2/snippet/textarea.html"),
        i = e("text!templates2/snippet/textinput.html");
    return {
        formname: t,
        prependedtext: n,
...
}(this)), define("views/snippet", ["jquery", "underscore", "backbone", "text!templates2/popover/popover-main.html", "text!templates2/popover/popover-input.html", "text!templates2/popover/popover-select.html", "text!templates2/popover/popover-textarea.html", "text!templates2/popover/popover-textarea-split.html", "text!templates2/popover/popover-checkbox.html", "templates/snippet/snippet-templates2", "bootstrap"], function(e, t, n, r, i, s, o, u, a, f) {
...
}), define("text!templates2/app/temp.html", [], function() {
...
}), define("views/temp-snippet", ["jquery", "views/snippet", "text!templates2/app/temp.html", "helper/pubsub"], function(e, t, n, r) {
    return t.extend({
        initialize: function() {
...
}), define("text!templates2/app/tab-nav.html", [], function() {
    return '<li><a href="#<%= id %>" data-toggle="tab"><%= title %></a></li>\n'
}), define("views/tab", ["jquery", "underscore", "backbone", "text!templates2/app/tab-nav.html"], function(e, t, n, r) {
    return n.View.extend({
        tagName: "div",
        className: "tab-pane",
        initialize: function() {
...
}), define("text!templates2/app/renderform.html", [], function() {
    return '<form class="form-horizontal">\n<fieldset>\n\n<%= text %>\n</fieldset>\n</form>\n'
}), define("Guid", function() {}), define("views/my-form", ["jquery", "underscore", "backbone", "views/temp-snippet", "helper/pubsub", "text!templates2/app/renderform.html", "Guid"], function(e, t, n, r, i, s) {
    return n.View.extend({
        tagName: "fieldset",
        initialize: function() {
...
}), define("text!templates2/app/render.html", [], function() {
    return '<h6>Rendered source of your form:</h6>\n<textarea id="render" class="render p-3"></textarea>\n'
}), define("app/app", ["jquery", "underscore", "backbone", "collections/snippets", "collections/my-form-snippets", "views/tab", "views/my-form", "text!data/input.json", "text!data/radio.json", "text!data/select.json", "text!data/buttons.json", "text!templates2/app/render.html"], function(e, t, n, r, i, s, o, u, a, f, l, c, h) {
    return {
        initialize: function() {
            new s({
                title: "Input",
